...
final class DatePickerView: BaseView, BottomSheet {
    ...
    let navigationBar = ClodyNavigationBar(type: .bottomSheet, title: .Calendar.calendarOtherDay)
    ...
    override func setStyle() {
        ...
        completeButton.do {
            ...
            let attributedTitle = UIFont.pretendardString(text: .Calendar.calendarComplete, style: .body2_semibold)
