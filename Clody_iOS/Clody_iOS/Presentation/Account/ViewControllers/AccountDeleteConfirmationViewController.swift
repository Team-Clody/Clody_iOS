...
final class AccountDeleteConfirmationViewController: UIViewController {
    
    // MARK: - Properties
    private let viewModel = AccountDeleteConfirmationViewModel()
    private let disposeBag = DisposeBag()
    
    // MARK: - UI Components
    private let rootView = AccountDeleteConfirmationView()
